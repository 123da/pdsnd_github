...
''')
    ...
    print ('The month picked is:', months[df['month'].mode()[0]
           - 1].title())
...
''')
    ...
    print ('The most commonly used start station: ', df['Start Station'
           ].mode()[0])

    # display most commonly used end station

    print ('The most commonly used end station: ', df['End Station'
           ].mode()[0])
...
''', df['Gender'].value_counts())
        ...
        print ('\nThe Earliest year of birth: ', int(df['Birth Year'
               ].min()))
        print ('\n Most common year of birth: ', int(df['Birth Year'
               ].mode()[0]))
        print ('\n The latest year of birth: ', int(df['Birth Year'
               ].max()))
...
''')
            if show_data.lower() != 'yes':
                ...
                print ('\nAfter applying filters, the dataset for {} contains {} rows.'.format(city,
                        df.shape[0]))
